...
$flag1=file_get_contents("../flags/flag1.txt");
$flag2=file_get_contents("../flags/flag2.txt");
$flag3=file_get_contents("../flags/flag3.txt");
$flag4=file_get_contents("../flags/flag4.txt");
$pass1=file_get_contents("../pass/pass1.txt");
$pass2=file_get_contents("../pass/pass2.txt");
$pass3=file_get_contents("../pass/pass3.txt");
$pass4=file_get_contents("../pass/pass4.txt");
$hash1=file_get_contents("../hashs/hash1.txt");
$hash2=file_get_contents("../hashs/hash2.txt");
$hash3=file_get_contents("../hashs/hash3.txt");
$hash4=file_get_contents("../hashs/hash4.txt");
...
<article class="module width_3_quarter">
    ...
    <div class="module_content">
        ...
        <p>
            Here is a heat map image of someone entering their pin, also note it is 16 digits long.
...
<article class="module width_quarter">
    ...
    <div class="message_list ">
        <div class="module_content">
            <div class="message ">
                <p><strong>essage From: JohnDelgado@ecwi.cysca</strong></p>
            ...
            <P>All the Hashs have been created with a salt at the begining.
                <h4>The salt is: cysca2015 </h4></P>
            <p>regards, John Delgado.
        </div>
    </div>
</article>
<article class="module width_3_quarter">
...
<article class="module width_3_quarter">
    ...
    <div class="module_content">
        ...
        <p>
            aybe substitution is too simple with today's password crackers.
        </p>
        <p>Crack this hash:
...
<article class="module width_3_quarter">
    ...
    <div class="module_content">
        ...
        <p>
            26 lowercase chars or 26^25 = 236773830007967588876795164938469376 combinations, not really.
        </p>
        <p>Crack this hash:
