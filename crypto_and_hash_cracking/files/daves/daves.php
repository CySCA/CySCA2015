<?php
    ...
    $DHG = new DHG();
    $secret = trim(file_get_contents('../hashs/hash5.txt'));
...
<head>
    <meta charset="utf-8" />
    <title>ECWI - Daves Secret Hash</title>
        ...
        ?>
            <article class="module width_full">
                ...
                <div class="module_content">
                    ...
                    <div class="module_content">
                        <p> Your input was: <strong><?php echo htmlentities($string); ?> </strong></p>
                        <p> Generated Hash:
                            <?php echo $compare; ?>
                        </p>
                        <P> Original Hash :
            ...
            <article class="module width_quarter ">
                ...
                <div class="message_list ">
                    <div class="module_content ">
                        ...
                        <P>I still cannot believe, no one else has considered combining multiple hashing
                           algorithms to make a greater, stronger, hash.</P>
                        <br>
			<P>Regards,</P>
                        <p>Cherry.</p>
                    </div>
